<x-layout>
    ...
    {{-- <article class="py-8 max-w-screen-md border-b border-gray-500">
        ...
        <a href="/blog" class="font-medium text-blue-500 hover:underline">&laquo; Back to post</a>
    </article> --}}
        ...
        <div class="flex justify-between px-4 mx-auto max-w-screen-xl ">
            <article
                ...
                <header class="mb-4 lg:mb-6 not-format">
                    ...
                    <a href="/blog" class="font-medium text-sm text-blue-600 hover:underline">&laquo; Back to all posts</a>

                    <address class="flex items-center mb-6 mt-5 not-italic">
